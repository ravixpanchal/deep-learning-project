...
data_dir = 'D:/RaviKaGroup/ImageProcessing/try1_2110/ImgToPdf/RawOutput'  # directory containing class folders
num_classes = 3
batch_size = 32
num_epochs = 25
lr = 1e-4
...
for epoch in range(num_epochs):
    ...
    train_accuracies.append(epoch_acc)  # Store the training accuracy
    ...
    val_accuracies.append(val_acc)  # Store the validation accuracy
...
# Bar width
bar_width = 0.25
index = np.arange(len(class_names))  # x-axis positions for classes
